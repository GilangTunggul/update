    ...
    <v-container>
      <v-col cols="12">
          ...
          >
            ...
            <v-card-subtitle>Create Your Own Table</v-card-subtitle>
                  ...
                  <v-container>
                    <v-row>
                      <v-col cols="12" sm="12" >
                       ...
                       <v-col cols="12" sm="12" >
                         <v-text-field autofocus color="error" v-model="editedItem.division" label="Division"></v-text-field>
                       </v-col>
                       <v-col cols="12" sm="12" >
                         <v-text-field autofocus color="error" v-model="editedItem.priority" label="Priority"></v-text-field>
                       </v-col>
                      <v-col cols="12" sm="12" >
                         <v-text-field autofocus color="error" v-model="editedItem.date" label="Date"></v-text-field>
                       </v-col>
                     </v-row>
                  </v-container>
                </v-card-text>
